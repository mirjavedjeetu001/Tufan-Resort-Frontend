      ...
      <main className="pt-16">
              ...
              {featuredRooms.length > 0 ? featuredRooms.map((room: any) => (
                <div key={room.id} className="card-premium overflow-hidden group">
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <Link href={`/rooms/${room.id}`} className="btn-premium bg-gradient-to-r from-primary-500 to-primary-600 text-white py-2.5 sm:py-3 rounded-lg text-sm sm:text-base font-semibold hover:shadow-glow transition-all duration-300 block text-center">
                      View Details & Book
                    </Link>
                  </div>
                </div>
        ...
        <section className="py-12 sm:py-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="container mx-auto px-4">
              ...
              {halls.length > 0 ? halls.slice(0, 3).map((hall: any) => (
                <div key={hall.id} className="card-premium overflow-hidden group">
                  ...
                  <div className="p-6">
                    ...
                    <Link href="/convention-hall" className="btn-premium bg-gradient-to-r from-primary-500 to-primary-600 text-white py-3 rounded-lg font-semibold hover:shadow-glow transition-all duration-300 block text-center">
                      View Details & Book
                    </Link>
                  </div>
                </div>
            ...
            <div className="text-center mt-8">
              <Link href="/convention-hall" className="bg-accent text-dark px-8 py-3 rounded-lg font-semibold hover:bg-yellow-500 transition inline-block">
        ...
        <section className="py-12 sm:py-16 bg-gradient-to-r from-primary-600 to-primary-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <a href={`tel:${resortInfo?.phone || '+880-XXX-XXXXXX'}`} className="bg-accent text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-bold text-lg sm:text-xl hover:bg-accent-600 transition inline-block shadow-lg hover:shadow-glow">
